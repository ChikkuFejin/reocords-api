...
ALTER TABLE assessment_instructions
    ADD CONSTRAINT assessment_instructions_assessments_fk
...
ALTER TABLE assessment_sections
    ADD CONSTRAINT assessment_sections_assessment_id_fk
        FOREIGN KEY (assessment_id) REFERENCES assessments(id);
...
INSERT INTO participants (
    ...
    standard_section_id
      ...
      (1, 'John Doe', 'R001', '$2b$10$hashedpassword1', 'john.doe@example.com', '9876543210', 5),
      (1, 'Jane Smith', 'R002', '$2b$10$hashedpassword2', 'jane.smith@example.com', '9876543211', 5),
      (1, 'Michael Johnson', 'R003', '$2b$10$hashedpassword3', 'michael.j@example.com', '9876543212', 5);
...
INSERT INTO institutions (name, gst, email, mobile)
VALUES
    ('Green Valley High School', 'GST123456', 'contact@gvhigh.edu', '9876543210'),
    ('Sunrise Public School', 'GST654321', 'info@sunrise.edu', '9123456780'),
    ('Blue Ocean Academy', 'GST789456', 'admin@blueocean.edu', '9988776655');


INSERT INTO standards
(name, description, is_active, institution_id)
VALUES
...
ALTER TABLE categories
    ADD CONSTRAINT fk_categories_standard_id 
...
SET c.standard_id = ss.standard_id
